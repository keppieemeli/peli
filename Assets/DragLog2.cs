...
public class DragLog2 : MonoBehaviour
{
    public bool Fire;
    ...
    public IEnumerator LightLogKeyPress()
    {
        ...
        gameObject.GetComponent<GlobalFireSpread>().IsFire3 = true;

        Fire = true;
        gameObject.GetComponent<GlobalFireSpread>().LateFireCheck3();
        ...
        Fire = false;
        gameObject.GetComponent<GlobalFireSpread>().LateFireCheck3();
        itself.GetComponent<GlobalFireSpread>().IsFire3 = false;
