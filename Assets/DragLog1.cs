...
public class DragLog1 : MonoBehaviour
{
    public bool Fire;
    ...
    public IEnumerator LightLogKeyPress()
    {
        ...
        gameObject.GetComponent<GlobalFireSpread>().IsFire2 = true;
        
        Fire = true;
        gameObject.GetComponent<GlobalFireSpread>().LateFireCheck2();
        ...
        Fire = false;
        gameObject.GetComponent<GlobalFireSpread>().LateFireCheck2();
        itself.GetComponent<GlobalFireSpread>().IsFire2 = false;
